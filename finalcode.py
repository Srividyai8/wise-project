...
class ImageGallery(tk.Frame):
    def __init__(self, master, image_paths, transition_callback):
        ...
        arrow_image_path = r"C:\Users\Srividya\OneDrive\Desktop\wiseproject\next.png"
        ...
        arrow_left_image_path = r"C:\Users\Srividya\OneDrive\Desktop\wiseproject\left_arrow.png"
...
def play_sound():
    pygame.mixer.init()
    pygame.mixer.music.load(r"C:\Users\Srividya\OneDrive\Desktop\wiseproject\hangman.mp3")
...
def start_hangman_game(root, player_name):
    ...
    gif_path = r"C:\Users\Srividya\OneDrive\Desktop\wiseproject\game.gif"
...
def start_hangman_game_play(root, frame, player_name):
    ...
    photos = [load_and_resize_image(f"C:\\Users\\Srividya\\OneDrive\\Desktop\\wiseproject\\hangman{i}.png") for i in range(7)]
...
def show_leaderboard(root):
    ...
    try:
        ...
        print("Loaded leaderboard:", leaderboard)  # Debug statement
    except FileNotFoundError:
        leaderboard = {}
        print("Leaderboard file not found. Using an empty leaderboard.")  # Debug statement

    # Sort the leaderboard
    sorted_leaderboard = sorted(leaderboard.items(), key=lambda x: x[1], reverse=True)
    print("Sorted leaderboard:", sorted_leaderboard)  # Debug statement
    ...
    # Exit button
    exit_button = tk.Button(frame, text="Exit", command=root.destroy, font=("Helvetica 18 bold"), bg="#e74c3c", fg="white", bd=2, relief="raised")
...
if __name__ == "__main__":
    ...
    image_paths = [
        r"C:\Users\Srividya\OneDrive\Desktop\wiseproject\homepage1.png",
        r"C:\Users\Srividya\OneDrive\Desktop\wiseproject\rule1.png",
        r"C:\Users\Srividya\OneDrive\Desktop\wiseproject\rule2.png",
        r"C:\Users\Srividya\OneDrive\Desktop\wiseproject\rule3.png",
        r"C:\Users\Srividya\OneDrive\Desktop\wiseproject\rule4.png",
        r"C:\Users\Srividya\OneDrive\Desktop\wiseproject\rule5.png",
        r"C:\Users\Srividya\OneDrive\Desktop\wiseproject\rule6.png",
        r"C:\Users\Srividya\OneDrive\Desktop\wiseproject\rule7.png"
    ]
